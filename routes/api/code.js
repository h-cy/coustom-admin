...
router.get('/:phone', async (req, res) => {
    ...
    const accountSid = '3023df36e8a840af922088e17c865b36'; // 账号id
    const authToken = 'bccb7443aaf14bac9fe2a2ae1990ec90'; // 令牌
    const templateid = '956820661'; // 短信模板id
    const param = `${code},1`; // 短信变量，多个变量用英文逗号隔开
    const now = moment();
